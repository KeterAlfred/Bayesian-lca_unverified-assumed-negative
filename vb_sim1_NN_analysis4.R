...
#
#
# Analysis of simulated data - assuming untested are negative
#
#===========================================================================
...
#Read the data
#Source the dataset
# source("data_for_sim0_sim1_NN.R")
...
source("data_for_sim1_NN.R")
# sim1_dat = readRDS(file.path(project.path = getwd(),"sim1_dat.RData"))



source("sim_Model_NN.R")
...
time.1 <- system.time( #getDoParWorkers( )
  vb.sim1.NN.res76_100 <- foreach( m = 1:M, .inorder = FALSE, 
            ...
            print(paste("Fitting model",m, sep = ""))
             ...
             result = jags.parallel(data = sim1_dat[[m]], inits = jags.inits.1,
                      ...
                      model.file = 'sim_model1_NN.txt', n.chain = 3, 
...
saveRDS(vb.sim1.NN.res76_100, file = "/kyukon/data/gent/438/vsc43892/vb_sim_analysis/vb.sim1.NN.res76_100.RData")
# saveRDS(vb.sim1.NN.res1_100, file = "C:\\Users\\aketer\\OneDrive - ITG\\EDCTP\\PhD\\lca\\Vukuzazi\\revised analysis\\vb_sim_analysis\\vb.sim1.NN.res1_100.RData")


print( vb.sim1.NN.res76_100, intervals = c(0.5, 0.025, 0.975))
